<?php
  ...
  class AppController extends AbstractController
  {
    ...
    public function mailActivarusuario($mail,$token,$fecha_exp)
    {
                        ...
                        <td width="560" align="center" valign="top" style="padding:0;Margin:0;">
                         <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;">
                           ...
                           <tr style="border-collapse:collapse;">
                            ...
                            Â© Consuerte S.A '.date('Y').' - Todos los derechos reservados<br>
                            <a href="https://www.consuerte.com.co/politica.pdf">PolÃ­tica de tratamiento de datos personales</a><br>
                            <a href="https://www.consuerte.com.co/terminos.pdf">TÃ©rminos y Condiciones </a>
                            </p></td>
                           </tr>
                         </table></td>
                       </tr>
      ...
      $sPara=$mail;
      $sAsunto="Consuerte S.A - Activaci�n de Cuenta";
                    ...
                    try
                    {
                      ...
                      if($statusCode == "200")
                      {
                        ...
                        if($dat_ws[0]==1)//si existe
                        {
                          ...
                          {
                            //1|CORDOBA ZU�IGA ANCIZAR|$1,087,393|2020-04-21|A|PENDIENTE|11302784|1087393|10766|0
                            $status=$dat_ws[0];
                            $totalvista=$dat_ws[2];
                            $vence=$dat_ws[3];
                            $estado=$dat_ws[4];
                ...
                if(count($res_usu)>0)//($res_usu->fields>0)
                {
                  ...
                  if($p1==$p2)
                  {
                    ...
                    if(count($res_2)>0)//($res_2->fields>0)
                    {
                      ...
                      {
                        array_push($val, array("status" =>1,"msm"=> mb_convert_encoding("Contrase�a Actualizada.",'utf8')));//utf8_encode("Contrase�a Actualizada.")));
                      }
                      else
                      {
                    ...
                    {
                      array_push($val, array("status" =>0,"msm"=> mb_convert_encoding("La contrase�a actual no es Correcta.",'utf8')));//utf8_encode("La contrase�a actual no es Correcta.")));
                    }
                  }
                  else
                  {
                    array_push($val, array("status" =>0,"msm"=>mb_convert_encoding("Las contrase�as nuevas no coinciden, intente nuevamente.",'utf8')));//utf8_encode("Las contrase�as nuevas no coinciden, intente nuevamente.")));
                  }
                }
                else
                {
